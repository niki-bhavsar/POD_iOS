...
class NotificationTableCell: UITableViewCell {
    ...
    @IBAction func btnDelete(sender:UIButton){
        ...
        deleteAlert.addAction(UIAlertAction(title: "Yes", style: .default, handler: { (action: UIAlertAction!) in
            let obj = MyOrderController.listNotification![self.indexPath.row] as [String:AnyObject];
            MyOrderController.DeleteNotificatins(userId: obj["customerId"] as! String, notificationID: obj["Id"] as! String, vc: self.vc)
        }))
